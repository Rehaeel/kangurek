            ...
            <Sections width={60}>
                <div className="kangoroo-club-site">
                    <p><b>KLUB KANGURKA</b><br />
                        ...
                        <br />Zapraszamy wszystkie dzieci, a w szczególności  z grupy ryzyka zaburzeń integracji sensorycznej (nieprawidłowości okołoporodowe, wcześniactwo, nieprawidłowości w napięciu mięśniowym, obniżona punktacja Apgar, problemy ze spaniem, ssaniem, nadwrażliwość  na bodźce).</p>
                    <div>
                        <div>
                    ...
                    <p>Podczas zajęć  dziecko doświadcza różnorodnych bodźców  zmysłowych,  co odpowiednio i całościowo stymuluje jego rozwój. Rozbudzamy  naturalną ciekawość  dzieci.  Towarzyszy nam muzyka i śpiew. Wprowadzamy  dzieci w świat kształtów, kolorów, zapachów, dźwięków.  Wspieramy  rozwój psychoruchowy, usprawniamy  motorykę dużą i małą. Nie brakuje  też  gimnastyki buzi i języka, wspierających rozwój mowy.
                        <br />Rodzice poznają  dziecięce masażyki i zabawy paluszkowe. Dowiadują się w jaki sposób prawidłowo stymulować  maluszka poprzez proste aktywności i zabawę.
                        <br />Rodzice z dziećmi  świetnie bawią się, poznają  pomysły na  kreatywne, wspierające rozwój spędzania czasu.
                        <br />Korzyści z uczestniczenia w zajęciach:
                    </p>
                    <ul>
