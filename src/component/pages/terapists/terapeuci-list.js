...
export const terapeuciList = [
    {
        ...
        expirience: <>
            <p>Z wyksztalcenia pedagog nauczania początkowego i wychowania fizycznego. Ma wieloletnie  doświadczenie w pracy z dziećmi zarówno w normie jak i z różnym stopniem niepełnosprawności. Dobry kontakt z dziećmi autystycznymi i niemówiącymi.</p>
            <p>Od 1998 roku pracuje jako nauczyciel  w grupie rewalidacyjno-wychowawczej oraz  w klasie z   uczniami z autyzmem w Ośrodku Szkolno Wychowawczym nr 3 w Bydgoszczy. Od 2013 roku prowadzi terapię integracji sensorycznej w Centrum Wspierania Rozwoju SENSO w Osielsku oraz w Centrum Terapii i Rehabilitacji SENSIS w Bydgoszczy.</p>
            <p>Nauczyciel akademicki z zakresu <em>Komunikacji alternatywnej i wspomagającej</em> oraz <em>Zaburzeń integracji sensorycznej</em>. Dzieli się swoją wiedzą ze studentami Bydgoskiego Zakładu Doskonalenia Zawodowego, K-PSW, RCE w Bydgoszczy oraz w Pile na WSG i Pracowni Edukacji i Coachingu.</p>
            <p>W-ce prezes stowarzyszenia Ruch na Rzecz Godności Osób Niepełnosprawnych WYZWANIE.</p>
        </>
    },
    {
        name: 'Maria Bandoch',
