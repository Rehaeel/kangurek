                ...
                <Sections sectionWidth={70}>
                    ...
                    <div className="contact">
                        <div className="contact-info">
                            ...
                            <a href="tel:+48505776121"><img src={tel} /></a>

                            <p>Mail: <a href="mailto:info@centrum-kangurek.pl">info @centrum-kangurek.pl</a></p>
                            <a href="mailto:info@centrum-kangurek.pl"><img src={mail} /></a>
                        ...
                        <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d2393.3631980881983!2d18.0299779!3d53.139576!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x470313e4298cd6bd%3A0x26e0e0577a21e6d9!2sCentrum+Kangurek!5e0!3m2!1spl!2spl!4v1504606219610" width="800" height="400" frameborder="0" allowfullscreen>
...
class Sections extends React.Component {
    render() {
        return (
            <div className="sections" style={{ display: 'block', width: `${this.props.sectionWidth}%`, margin: '80px auto', textAlign: 'center' }}>
                {this.props.children}
            </div>
        )
    }
