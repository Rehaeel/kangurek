...
const SensomotorycznaTerapiaWidzenia: NextPage = () => {
	return (
		<OfferWrapper
			...
			image={stwHeaderImg}>
			<b className='font-black'>Sensomotoryczna terapia widzenia (STW)</b>

			<p>
				STW to program łączący statyczną i dynamiczną terapię funkcji
				wzrokowych. Wykorzystuje integrację bodźców wzrokowych,
				słuchowych i ruchowych.
			</p>
			<p>
				Ćwiczenia wzrokowe są wykonywane zarówno w pozycjach statycznych
				jak i w ruchu, angażując do pracy układ przedsionkowy i
				proprioceptywny. Dzięki temu następuje właściwa integracja
				bodźców wzrokowych z pozostałymi zmysłami. Metodę
				Sensomotorycznej terapii widzenia można stosować podczas
				klasycznych zajęć integracji sensorycznej, terapii pedagogicznej
				lub jako niezależną formę terapii. Na zajęciach wykorzystuje się
				stymulatory, które pozwalają na lepszą integrację wzrokowo-
				słuchową. Taka umiejętność stanowi podstawę uczenia się.
			</p>
				...
				<div className='flex flex-col gap-7'>
					...
					<ul className='list-inside list-disc pl-0 sm:pl-5'>
						<li>
							...
							matematycznych, obniżony poziom rozumienia, obniżona
							pamięć wzrokowa i słuchowa oraz motoryczna
						</li>
