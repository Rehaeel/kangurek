      ...
      <PageWrapper title="Praca" image="/images/pages/praca/Praca.jpg">
        <PageContent>
          <div className="flex flex-col gap-4">
            <p>
              Zapraszamy do współpracy ambitnych i pracowitych terapeutów, ludzi
              z pasją, kochających dzieci i chcących rozwijać się zawodowo
            </p>

            <p>Wymagania:</p>
            <ul className="list-inside list-disc">
              <li>
                Wykształcenie lub ukończone kursy terapii Integracji
                Sensorycznej pierwszego i drugiego stopnia
              </li>
              <li>
                Umiejętność pracy z dziećmi i nawiązywania dobrych relacji z
                nimi i rodzicami.
              </li>
            ...
            <p>
              Oferujemy pracę w dobrze wyposażonej Sali Integracji Sensorycznej,
              w miłej i przyjaznej atmosferze.
            </p>
            <p>
              Jeśli jesteś osobą, która spełnia powyższe wymagania i chciałabyś
              dołączyć do naszego zespołu, prosimy o przesłanie CV oraz kontaktu
              pod adresem email:
            </p>
            <Link
            ...
            <p>
              Zapraszamy również studentów na praktyki, a po ukończeniu szkoły
              jest możliwość podjęcia pracy u nas.
            </p>
          </div>
        </PageContent>
      </PageWrapper>
