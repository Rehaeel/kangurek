		...
		<OfferWrapper title='Kynoterapia' image={headerImg}>
			<div className='sm:gap-700 grid grid-cols-1 items-center gap-4 lg:grid-cols-2'>
				<div className='flex flex-col gap-5 lg:gap-7'>
					...
					<p>
						jest to metoda, wspierająca wszechstronny rozwój dziecka
						przy wykorzystaniu specjalnie szkolonego psa.
					</p>
					<p>
						Poprzez np.: głaskanie, karmienie, naśladowanie zachowań
						zwierzaka, prowadzenie go na smyczy, wydawanie komend i
						wspólnej zabawy osiągamy zamierzone, terapeutyczne cele
						takie jak:
					</p>
					<ul className='flex list-inside list-disc flex-col  gap-1 pl-0 sm:pl-5 lg:gap-2'>
						...
						<li>
							rozładowanie napięcia emocjonalnego, panowanie nad
							emocjami
						</li>
