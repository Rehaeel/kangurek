			...
			<div className='grid grid-cols-1 gap-4 sm:gap-7 md:grid-cols-2'>
				<div className='flex flex-col gap-5'>
					<p>
						...
						sensoryczną, elementy zajęć ogólnorozwojowych, terapię
						widzenia, kreatywność, zabawy paluszkowe, ćwiczenia z
						zakresu samoobsługi.
					</p>
					<p>
						Kontrola nad ciałem rozwija się stopniowo, poczynając od
						głowy przechodząc w kierunku stóp, potem osiągamy
						stabilizację centralną, aż do sprawnego posługiwania się
						dłonią.
					</p>
				</div>
				<div className='flex flex-col gap-5'>
