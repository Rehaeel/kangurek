...
export const terapeuciList: Terapeuta[] = [
	{
		name: 'Barbara Prokopiak',
		image: 'Barbara-Prokopiak',
		education: [
			'OLIGOFRENOPEDAGOG',
		...
		experience: (
			<>
				<p>
					Z wyksztalcenia pedagog nauczania początkowego i wychowania
					fizycznego. Ma wieloletnie doświadczenie w pracy z dziećmi
					zarówno w normie jak i z różnym stopniem niepełnosprawności.
				...
				<p>
					...
					<em>Komunikacji alternatywnej i wspomagającej</em> oraz{' '}
					<em>Zaburzeń integracji sensorycznej</em>. Dzieli się swoją
					wiedzą ze studentami Bydgoskiego Zakładu Doskonalenia
					Zawodowego, K-PSW, RCE w Bydgoszczy oraz w Pile na WSG i
	...
	},
	{
		...
		experience: (
			<>
				<p>
					Od zawsze pracuje z dziećmi, nawet bardzo małymi. Z
					powodzeniem prowadzi też terapię z dorosłymi.
				</p>
				<p>
	...
	},
	{
		...
		image: 'Monika-Frontczak',
		education: ['FIZJOTERAPEUTKA'],
		experience:
	...
	{
		name: 'Dominika Kondek',
		image: 'Dominika-Kondek',
		education: [
			'PEDAGOG WYCHOWANIA PRZEDSZKOLNEGO I NAUCZANIA POCZĄTKOWEGO',
			'TERAPEUTA INTEGRACJI SENSORYCZNEJ',
