...
const WartoWiedziec: NextPage = () => {
	return (
		<PageContent>
			<div className='flex flex-col w-8/12 items-start gap-5 my-12'>
				<b className='font-extrabold'>
					Sprawdź, czy Twoje dziecko ma zaburzenia integracji
					sensorycznej.
					<br />
					Jeżeli Twoje odpowiedzi są na TAK, zgłoś dziecko na diagnozę
					i ocenę rozwoju procesów integracji sensorycznej:
				</b>
				<ol className='flex flex-col gap-3 list-decimal list-inside'>
					...
					<li>
						podczas dłuższego siedzenia ma trudności z utrzymaniem
						głowy w pozycji pionowej, podpiera ją ręką, kładzie się
						na stoliku,
					</li>
					<li>
					...
					<li>
						jest nadruchliwe, nie może usiedzieć / ustać w jednym
						miejscu,
					</li>
					...
					<li>
						nagłe dotknięcie / popchnięcie z tyłu wywołuje u dziecka
						„reakcję alarmową”, niewspółmierną do siły bodźca,
					</li>
					<li>ma kłopoty z czytaniem z tablicy,</li>
					<li>trudno się koncentruje, a łatwo się rozprasza,</li>
					<li>
						siadając na krześle czy poprawiając na nim swoją pozycję
						zdarza się, że spada,
					</li>
					...
					<li>
						nabycie nowej umiejętności wymaga od dziecka wielu prób
						i powtórzeń,
					</li>
					<li>
						nie lubi dziecięcego baraszkowania, nie lubi turlać się
						po podłodze, podskakiwać, robić fikołków,
					</li>
					<li>
					...
					<li>
						długo uczy się nowych aktywności fizycznych tj.: jazda
						na rowerze, pływanie, a czasem mimo wysiłku nie udaje mu
						się ich opanować,
					</li>
					<li>
					...
					<li>
						okazuje niepokój, gdy musi oderwać nogi od podłoża, np.:
						wejść na wysokie schody, na drabinkę, usiąść na wysokim
						stołku,
					</li>
