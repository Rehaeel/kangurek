...
const TerapiaPedagogicznaPage: NextPage = () => {
	return (
		<OfferWrapper title='terapia pedagogiczna' image={tp}>
			...
			<p>
				Zajęcia z terapii pedagogicznej służą wspomaganiu rozwoju dzieci
				z różnymi trudnościami, które wpływają niekorzystnie na proces
				zdobywania umiejętności szkolnych. Często przyczyny będące
				podłożem trudności dzieci są trudne do zdiagnozowania lub bardzo
				złożone, dzieci samodzielnie nie są w stanie poradzić sobie z
				narastającymi problemami. Braki, które pojawiają się na początku
				drogi edukacyjnej, narastają, kumulują się, obejmują coraz
				szersze obszary. W efekcie stają się przyczyną dodatkowych
				zaburzeń np. emocjonalnych.
			</p>
			<div className='flex flex-col items-center justify-between gap-7 lg:flex-row'>
				<div className='flex flex-col gap-7'>
					...
					<p>
						Podczas zajęć prowadzimy ćwiczenia z czytania, pisania,
						liczenia.
						<br />
						Robimy to w kreatywny sposób specjalnymi metodami, które
						są interesujące dla dziecka i motywują do nauki.
					</p>
				</div>
				<Image
					src={teraphy}
