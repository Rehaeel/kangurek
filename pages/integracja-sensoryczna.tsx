...
const IntegracjaSensorycznaPage: NextPage = () => {
  ...
  return (
    <>
      ...
      >
        <b className="font-black underline">Integracja sensoryczna (SI)</b>

        <p>
          Zakłócenia na poziomie organizacji i odbioru wrażeń zmysłowych mogą
          skutkować nieadekwatnym zachowaniem dziecka, trudnościami w uczeniu
          się, a także powodować zaburzenia funkcji ruchowych.
        </p>
        <p>
          Interweniujemy terapeutycznie wtedy, gdy luka między tym, czego by się
          oczekiwało od dziecka na danym etapie wiekowym w zakresie SI a tym, co
          ono prezentuje jest na tyle duża, że dziecku nie udaje się go wyrównać
          w trakcie zabaw i innych czynności naturalnych.
        </p>
        <div className="flex flex-col items-center justify-between gap-7 lg:flex-row">
          <div className="flex flex-col gap-7">
            ...
            <ul className="list-inside list-disc pl-0 sm:pl-5">
              <li>
                nadwrażliwość na bodźce (np. zatykanie uszu, nie lubią mycia
                włosów, obcinania paznokci)
              </li>
              <li>problemy z jazdą na rowerze, hulajnodze</li>
              <li>
                trudności z koordynacją ruchową np. słabo wycinają , rysują, nie
                łapią i nie kopią piłki
              </li>
              ...
              <li>
                są nadmiernie aktywne ruchowo (ciągle biegają, skaczą, kręcą
                się, huśtają).
              </li>
            </ul>
          </div>
        ...
        <p>
          ...
          <Link href="/klub-kangurka" className="text-orange-color">
            KLUB KANGURKA
          </Link>{" "}
          wspierający rozwój procesu integracji sensorycznej.
        </p>
        <p>
          Przeprowadzamy diagnozę oceny rozwoju procesów integracji sensorycznej
          dziecka, które obejmują:
        </p>
        <ul className="list-inside list-disc pl-0 sm:pl-5">
          ...
          <li>
            przeprowadzanie Południowo Kalifornijskich Testów dla dzieci od 4
            r.ż.
          </li>
          <li>obserwację zachowania dziecka podczas badania</li>
          <li>
            obserwację swobodnej zabawy dziecka i jego reakcji na stymulację
            sensoryczną.
          </li>
        </ul>
