...
const IntegracjaSensorycznaPage: NextPage = () => {
	return (
		<OfferWrapper title='Integracja Sensoryczna (SI)' image={SI}>
			...
			<p>
				Zakłócenia na poziomie organizacji i odbioru wrażeń zmysłowych
				mogą skutkować nieadekwatnym zachowaniem dziecka, trudnościami w
				uczeniu się, a także powodować zaburzenia funkcji ruchowych.
			</p>
			<p>
				Interweniujemy terapeutycznie wtedy, gdy luka między tym, czego
				by się oczekiwało od dziecka na danym etapie wiekowym w zakresie
				SI a tym, co ono prezentuje jest na tyle duża, że dziecku nie
				udaje się go wyrównać w trakcie zabaw i innych czynności
				naturalnych.
			</p>
			<div className='flex flex-col items-center justify-between gap-7 lg:flex-row'>
				<div className='flex flex-col gap-7'>
					<p className='underline'>
						Integracja sensoryczna skierowana jest do dzieci, które
						mają:
					</p>
					<ul className='list-inside list-disc pl-0 sm:pl-5'>
						...
						<li>
							trudności z koordynacją ruchową np. słabo wycinają ,
							rysują, nie łapią i nie kopią piłki
						</li>
			...
			<ul className='list-inside list-disc pl-0 sm:pl-5'>
				...
				<li>
					przeprowadzanie Południowo Kalifornijskich Testów dla dzieci
					od 4 r.ż.
				</li>
