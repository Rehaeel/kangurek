...
NREUM.loader_config = {
  ...
  trustKey: "4382858",
  agentID: "538612981",
  licenseKey: "NRJS-c718cdc3948e14e7f8c",
  applicationID: "538612981",
};
NREUM.info = {
    ...
    r = {
      ...
      425: (e, t, r) => {
        ...
        function O(e) {
          ...
          N ||
            (P.proxy.assets && (S(P.proxy.assets), k.push(P.proxy.assets)),
          ...
          class extends b {
            ...
            constructor(e, t) {
              ...
              this.ee.on(Ne, m),
                ...
                this.ee.buffer([Ne, Ie, "xhr-resolved"], this.featureName),
                d.buffer([Ne], this.featureName),
                c.buffer(
                  ["setTimeout" + xe, "clearTimeout" + Re, Ne],
                  this.featureName
                ),
                u.buffer([Ne, "new-xhr", "send-xhr" + Re], this.featureName),
                l.buffer(
